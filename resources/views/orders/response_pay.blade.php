        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <div class="p-6">
                        <a href="{{url('/')}}"><img class="h-12 w-12" src="{{url('img/logo.png')}}" alt="Publicars"></a>
                    </div>
                    <div class="p-6">
                        <div class="bg-gray-50">
                            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
                                <h2 class="text-3xl font-extrabold tracking-tight text-gray-500 sm:text-4xl">
                                    	...
                                    	<?php if ( $order->status=='PENDING' ): ?>
											<div class="text-center p-6 shadow sm:rounded-lg" style="background: #B23CFD; color: white;">
												<div class="mt-5">
													...
													<h4>{{ 'Intentar continuar con el pago.' }}</h4>
												</div>
											</div>
                                    	<?php endif; ?>
